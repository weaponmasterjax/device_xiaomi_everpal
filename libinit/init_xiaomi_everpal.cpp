...
static const variant_info_t evergo_cn_info = {
    ...
    .model = "21091116AC",
    .build_fingerprint = "Redmi/evergo_cn/evergo:12/SP1A.210812.016/V14.0.0.12.TGBCNXM:user/release-keys",
...
static const variant_info_t evergo_in_info = {
    ...
    .model = "21091116AI",
    .build_fingerprint = "Redmi/evergo_in/evergo:12/SP1A.210812.016/V14.0.0.12.TGBINXM:user/release-keys",
...
static const variant_info_t evergo_in_p_info = {
    ...
    .model = "22031116AI",
    .build_fingerprint = "POCO/evergo_p_in/evergo:12/SP1A.210812.016/V14.0.0.12.TGBCNXM:user/release-keys",
